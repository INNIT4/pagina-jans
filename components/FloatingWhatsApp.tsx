...
export default function FloatingWhatsApp() {
  ...
  return (
    <button
      onClick={handleClick}
      className="hidden sm:block fixed bottom-6 right-6 z-50 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition-transform hover:scale-110"
